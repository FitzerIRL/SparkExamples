//
// SOURCE:  https://www.shadertoy.com/view/wl2SRK
//
...
float sdBox( vec3 p, vec3 b )
{
    ...
    //  Older OpenGL does not allow sub-matrix operations ... automagically making a 'mat3' from 'mat4' operations.
    //
    mat4 ans = rotationX(PHASE*TWOPI*5.0) * rotationZ(PHASE*TWOPI*18.0);
    p = mat3(ans[0].xyz, ans[1].xyz, ans[2].xyz)*p;

  //  Original code... using 'mat4' magic !
  //
